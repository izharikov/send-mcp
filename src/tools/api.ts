...
export const addApiTools: (server: McpServer, config: Partial<ApiConfig>, transactoinalConfog: { campaignId: string | undefined }) => void = (server, config, transactoinalConfog) => {
  if (!config.apiKey) {
    return;
  }
